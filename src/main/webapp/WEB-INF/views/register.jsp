        ...
        <div class="uk-width-1-3">
            <div uk-grid>
                <div class="uk-card uk-card-default uk-card-body uk-position-top-center uk-margin-medium-top">
                    <div class="uk-card-title">Регистрация</div>
                    <c:if test="${requestScope.error != null}">
                        <div class="uk-alert-danger" uk-alert>
                            <c:out value="${requestScope.error}"/>
                        </div>
                    </c:if>
                    <form class="uk-form-stacked" action="${pageContext.request.contextPath}/register.do" method="post">
                        <div>
                            <label class="uk-form-label">Имя</label>
                            <div class="uk-form-controls">
                                <input class="uk-form-width-medium uk-form-medium" type="text" name="name" required>
                            </div>
                        </div>
                        <div>
                        ...
                        <div class="uk-margin">
                            <button type="submit" class="uk-button uk-button-small uk-button-primary">Зарегистрироваться</button>
                        </div>
                    </form>
                </div>
            </div>
